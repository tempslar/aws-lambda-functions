...
def lambda_handler(event, context):
    ...
    # query = 'COPY public.' + s3KeyParts[1] + ' from ' + s3fullPath + '" iam_role "arn:aws:iam::657118881088:role/Redshift-s3-readonly-role-01" region "' + region + '" delimiter "," csv quote as \'"\';'
